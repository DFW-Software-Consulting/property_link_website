...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Contact PropertyLink NYC about furnished stays of 30 days or more, 12-month leases, and corporate housing in Manhattan. Call 888-622-0772 or send us a message.",
};
